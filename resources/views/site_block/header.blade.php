    ...
    <header class="navbar navbar-sticky">
        ...
        <div class="topbar">
            <div class="container">
                ...
                <div class="toolbar">
                    @if (Auth::guest())
                        <a href="{{ route('register') }}" class="text-sm">Зареструватися</a>
                    ...
                    @else
                        ...
                        @if(!Auth::user()->avatar == 'default.jpg')
                            <img src="/data/users/{{Auth::user()->email}}/avatar/{{ Auth::user()->avatar }}" style="width:25px; height:25px;  border-radius:50%;">
                        @else
